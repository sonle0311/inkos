...
const AGENT_LABELS: Record<string, readonly [string, string, string]> = {
  architect: ["建书", "Create book", "Tạo sách"], writer: ["写作", "Write", "Viết"], auditor: ["审计", "Audit", "Kiểm toán"],
  reviser: ["修订", "Revise", "Chỉnh sửa"], exporter: ["导出", "Export", "Xuất bản"],
};
const TOOL_LABELS: Record<string, readonly [string, string, string]> = {
  ...
  create_narrative_forecast: ["剧情多线推演", "Narrative forecast", "Diễn biến đa nhánh"],
  get_narrative_forecast: ["核验剧情推演", "Recheck forecast", "Kiểm tra diễn biến"],
